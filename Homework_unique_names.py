...
def get_names() -> str:
    ...
    for name in unique_names:
        all_names_sorted.append(name)

    all_names_sorted.sort()
    names_str = ", ".join(all_names_sorted)
    answers_str = (f'Уникальные имена преподавателей: {names_str}')
    return answers_str

# Ожидаемый результат
# Уникальные имена преподавателей: Адилет, Азамат, Александр, Алексей, Алена, Анатолий,
# Анна, Антон, Вадим, Валерий, Владимир,
# Денис, Дмитрий, Евгений, Елена, Иван, Илья, Кирилл, Константин, Максим, Михаил, Никита, Николай, Олег, Павел,
